    ...
    var $this = $(this),
      ...
      if($this.hasClass('client-control-next')) {
        ...
        if(position < clientNum -1){
          ...
          $('.clients-mobile-nav span').removeClass('active-client').first().addClass('active-client');
        }
        ...
        if (position === 0) {
          ...
          $('.clients-mobile-nav span').removeClass('active-client').last().addClass('active-client');
        } else {
